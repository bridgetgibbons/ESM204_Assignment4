...
MCa<-(slope_a*100) + yint_a 
MCb<-(slope_b*100) + yint_b
MCc<-(slope_c*100) + yint_c

MC<-rbind(MCa, MCb, MCc, NA)

costa<-(MCa*100)+(100*(yint_a-MCa)*0.5)
costb<-(MCb*100)+(100*(yint_b-MCb)*0.5)
costc<-(MCc*100)+(100*(yint_c-MCc)*0.5)
