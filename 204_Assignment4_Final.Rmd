...
```{r, echo = FALSE}
stargazer(lm_a, lm_b, lm_c, lm_d, type="text", title="Abatement Regression Results")
```
...
ggplot(data = carbon_tidy, aes(x=abatement, y = mc)) + geom_point() +
  ...
  theme_bw() +
  labs(x = "Abatement (tons)", y = "Marginal Cost", title = "Marginal Abatement Costs") 
```
...
#plot
par(mfrow=c(2,2)) 
plot(marg_benefit$emissions_A, marg_benefit$demand_A, main = "Sector A", xlab = "Pollution Emitted (Tons)", ylab = "Marginal Benefit ($/Ton)", type = "l", col = "red")
plot(marg_benefit$emissions_B, marg_benefit$demand_B, main = "Sector B", xlab = "Pollution Emitted (Tons)", ylab = "Marginal Benefit ($/Ton)", type = "l", col = "orange")
plot(marg_benefit$emissions_C, marg_benefit$demand_C, main = "Sector C", xlab = "Pollution Emitted (Tons)", ylab = "Marginal Benefit ($/Ton)", type = "l", col = "green")
plot(marg_benefit$emissions_D, marg_benefit$demand_D, main = "Sector D", xlab = "Pollution Emitted (Tons)", ylab = "Marginal Benefit ($/Ton)", type = "l", col = "blue")
```
...
Sector C has the highest willingnesss to pay for the first unit of carbon emissions at $160.7868 per ton. 
...
c. allowing cap and trade will lead to an increase in the tons of air pollution in country x and decrease it in country y.
